    ...
    <div class="container blocks_wrap">
        ...
        <div class="right_block">
            ...
            <div class="my_items_table_descr">
                <p>Показывается: 1-9 из 518 результатов</p>
                ...
                <a href="#" class="catalog_card">
                    <div class="top_card">
                        <div class="grade_card">
							<?php //require "assets/svg/hop.php";?>
                        </div>
                        <img src="assets/img/card_img.jpg" alt="Марка пива">
                    </div>
                    <div class="footer_card">
                        <h3>Миру-Beer, American Amber Ale</h4>
                        <hr>
                        <div class="brewery_mini">
                            <img src="assets/img/brewery_mini.png" alt="Логотип пивоварни">
